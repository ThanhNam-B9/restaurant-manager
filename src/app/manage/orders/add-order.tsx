...
export default function AddOrder() {
  ...
  const crearGuestMutation = useCreateGuest();
  const listDishesQuery = useDishesList();
  ...
  const handleOrder = async () => {
    ...
    try {
      ...
      if (isNewGuest) {
        const res = await crearGuestMutation.mutateAsync({
          name,
          tableNumber,
        });
        guestId = res.payload.data.id;
      }
